 ...
 * ControlMixer_2_to_1CADBlock.java
...
import com.holycityaudio.SpinCAD.ControlPanel.ControlMixer_2_to_1ControlPanel;

@SuppressWarnings("unused")
public class ControlMixer_2_to_1CADBlock extends SpinCADBlock {

	private static final long serialVersionUID = 1L;
	private ControlMixer_2_to_1ControlPanel cp = null;

	private double gain1 = 1.0;
	private double gain2 = 1.0;
	private int output;

	public ControlMixer_2_to_1CADBlock(int x, int y) {
		super(x, y);
		setName("Mixer 2:1");
	...
	public void editBlock() {
		if (cp == null) {
			if (hasControlPanel == true) {
				cp = new ControlMixer_2_to_1ControlPanel(this);
			}
		}
	}
