...
import com.holycityaudio.SpinCAD.ControlPanel.Mixer_3_to_1ControlPanel;

@SuppressWarnings("unused")
public class Mixer_3_to_1CADBlock extends SpinCADBlock {

	private static final long serialVersionUID = 1L;
	private Mixer_3_to_1ControlPanel cp = null;
	...
	public Mixer_3_to_1CADBlock(int x, int y) {
		super(x, y);
		setName("Mixer 3:1");
	...
	public void editBlock() {
		if (cp == null) {
			if (hasControlPanel == true) {
				cp = new Mixer_3_to_1ControlPanel(this);
			}
		}
	}
