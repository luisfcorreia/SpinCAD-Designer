...
import com.holycityaudio.SpinCAD.ControlPanel.Mixer_4_to_1ControlPanel;

@SuppressWarnings("unused")
public class Mixer_4_to_1CADBlock extends SpinCADBlock {

	private static final long serialVersionUID = 1L;
	private Mixer_4_to_1ControlPanel cp = null;
	...
	public Mixer_4_to_1CADBlock(int x, int y) {
		super(x, y);
		setName("Mixer 4:1");
	...
	public void editBlock() {
		if (cp == null) {
			if (hasControlPanel == true) {
				cp = new Mixer_4_to_1ControlPanel(this);
			}
		}
	}
