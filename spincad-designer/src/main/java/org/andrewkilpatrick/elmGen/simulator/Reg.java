...
public class Reg implements Serializable {
	...
	/**
	 * Sets the value of the register. The value is internally clamped to 24
	 * bits.
	 *
	...
	/**
	 * Subtracts the term from the current value of the reg. The term and
	 * value are clamped to 24 bits.
	 *
	...
	/**
	 * Multiplies the reg by a double coefficient. The coeff is clamped to a
	 * range of: -2.0 to +1.99993896484. The result is clamped to 24 bits.
	 *
	 * @param coeff the coeff to multiply the reg by
	 */
	...
	/**
	 * Loads the reg with the abs value of val if it is larger than the the
	 * abs value of reg.
	 *
